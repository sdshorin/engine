...
int main() {
	...
	std::shared_ptr<eng::TreeObject> rotated_node_teapot = std::make_shared<eng::RotationNode>(glm::vec3(0.0, 0, 1), 0.6);
	std::shared_ptr<eng::TreeObject> rotated_node_teapot2 = std::make_shared<eng::RotationNode>(glm::vec3(0.0, 1, 0), 0.3);
