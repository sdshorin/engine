...
void CPURender::RasterizerTriangle(ShaderImplementation* shader_imp, const Point& p_1, const Point& p_2,
                                   const Point& p_3) {
...
void CPURender::RenderScreen() {
    SDL_Surface* pixelSurface =
        SDL_CreateRGBSurfaceFrom(screen.frame_buffer, screen.window_width, screen.window_high,
